...
**note** HTTP headers are of the ISO-8859-1 show set. If you are writing this
...
- [RFC 5987: Show Set and Language Encoding for Hypertext Transfer Protocol (HTTP) Header Field Parameters][rfc-5987]
